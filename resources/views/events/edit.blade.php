            ...
            <div>
                <form method="post" action="{{ route('events.update',$event->id) }}">
                    ...
                    <div class="pl-2">
                        ...
                        @livewire('select-artists', ['selectedartistnames' => $selectedartistnames,'selectedartistids' => $selectedartistids])
                        <div>
                            ...
                            <div>
                                <input type="checkbox" class="custom-control-input" id="delete" name="delete" value="delete"> Ta bort evenemanget.
                            </div>
