<div class="text-center">
    ...
    <p class="mb-1">
        ...
        <span class="ml-3 text-sm text-gray-700">fr. o. m. </span><input wire:model="query" type="date" name="day" value="" class="text-sm border rounded-lg border-solid border-gray-300 text-gray-700 mt-2 mb-0 px-1 py-1"></p>
