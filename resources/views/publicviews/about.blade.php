<x-guest-layout>
    <div class="md:ml-60">
        ...
        <p class="max-w-prose">
            ...
            Du kan hjälpa mig eller påverka mig genom att tipsa, föreslå, uppmuntra, rätta eller klaga i
            <a class="text-blue-800" href="/contact">kontaktformuläret.</a>
