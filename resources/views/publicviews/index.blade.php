<x-guest-layout>
    <div class="bg-blue-100 rounded-lg max-w-screen-xl m-auto">
        <div class="grid grid-cols-1 md:grid-cols-12 md:gap-3">
            <div class="m-2.5 md:border-r md:border-dashed md:border-gray-400 md:col-span-3 order-2 md:order-1">
            ...
            <div class="m-2.5 md:border-l md:border-dashed md:border-gray-400 md:col-span-3 order-3">
